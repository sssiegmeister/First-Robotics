...
#pragma config(Sensor, S3,     turner,         sensorSONAR)
#pragma config(Sensor, S4,     HTIRS4,         sensorHiTechnicIRSeeker1200)
...
task driveForward()
{
	while(true)
	{
		while (SensorValue[turner]>distance)
		{
			//motor[driveL]=100;
			//motor[driveR]=100;
			HTIRS2readAllACStrength(HTIRS4, acS1, acS2, acS3, acS4, acS5 );
